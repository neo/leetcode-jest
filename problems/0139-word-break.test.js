...
describe("139. Word Break", () => {
  ...
  test("applepenapple", () => expect(wordBreak("applepenapple", ["apple", "pen"])).toBe(true));
  test("catsandog", () => expect(wordBreak("catsandog", ["cats", "dog", "sand", "and", "cat"])).toBe(false));
  test("aaaaaaa", () => expect(wordBreak("aaaaaaa", ["aaaa", "aaa"])).toBe(true));
  test("bedbathandbeyond", () =>
    expect(wordBreak("bedbathandbeyond", ["bed", "bath", "be", "bat", "and", "beyond"])).toBe(true));
  test("bathero", () => expect(wordBreak("bathero", ["bath", "bat", "hero"])).toBe(true));
  test("category", () => expect(wordBreak("category", ["cat", "category"])).toBe(true));
  test("aaaaaaaaaa", () =>
    expect(
      wordBreak(
